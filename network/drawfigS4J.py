...
axarr[0].set_position([0.09,0.66,0.426,0.15])
axnew = f.add_axes([0.43,0.77,0.07,0.05])
boxoff(axnew)
...
axarr[0].set_xlabel('$t$ (sec)',fontsize=6)
axnew.set_ylabel('[Ca$^{2+}$]\n(nM)',fontsize=5)

pos = axarr[0].get_position()
f.text(pos.x0 - 0.06, pos.y1 - 0.01, chr(ord('J')+0), fontsize=12)


f.savefig("figS4J.pdf")
