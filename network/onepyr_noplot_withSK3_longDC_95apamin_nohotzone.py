#Created by do_onepyr_withSK3_apamin_nohotzone.sh
from neuron import *
import sys
import os
import string
...
h.allfiles=allfiles = "pyinit.py geom_withSK3_95apamin.py onepyr.py"
h.simfiles=simfiles = "pyinit.py geom_withSK3_95apamin.py onepyr.py"
h("runnum=1")
...
from pyinit import *
from labels import *
from geom_withSK3_95apamin import *
from nqs import *
import random
from pylab import *
...
scipy.io.savemat(simstr+'_withSK3_95apamin_nohotzone_longDC_amp'+str(ICamp)+'.mat',{'spikes': spikes, 'Vsoma': array(cell.soma_volt), 'times': [recvdt*i for i in range(0,len(array(cell.soma_volt)))]})
