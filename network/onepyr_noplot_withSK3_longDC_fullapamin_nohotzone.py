...
scipy.io.savemat(simstr+'_withSK3_fullapamin_nohotzone_longDC_amp'+str(ICamp)+'.mat',{'spikes': spikes, 'Vsoma': array(cell.soma_volt), 'times': [recvdt*i for i in range(0,len(array(cell.soma_volt)))]})
