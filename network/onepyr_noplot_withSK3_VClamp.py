...
scipy.io.savemat(simstr+'_withSK3_VClamp_r'+str(r_VClamp)+'.mat',{'spikes': spikes, 'Vsoma': array(cell.soma_volt)[int(990/recvdt):int(1060/recvdt)], 'times': [recvdt*i for i in range(int(990/recvdt),int(1060/recvdt))], 'somaical': array(somaical)[int(990/recvdt):int(1060/recvdt)], 'somaican': array(somaican)[int(990/recvdt):int(1060/recvdt)], 'somaicat': array(somaicat)[int(990/recvdt):int(1060/recvdt)]})
