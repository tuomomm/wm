...
if saveoutSpikes:
  ...
  scipy.io.savemat(simstr+'_withIh.mat',{'spikes': spikes, 'Vsoma': array(cell.soma_volt), 'times': [recvdt*i for i in range(0,len(array(cell.soma_volt)))], 'HCNm': array(HCNm), 'lcai': array(lcai), 'cai': [array(cell.soma_cai),array(cell.Bdend_cai),array(cell.Adend1_cai),array(cell.Adend2_cai),array(cell.Adend3_cai)]})
